...
DllExport int32_t __stdcall EvaluateExpression(char* expression, CpuType cpuType, EvalResultType* resultType,
                                               bool useCache)
{
	auto dbg = GetDebugger();
...
DllExport void __stdcall GetMemoryAccessCounts(uint32_t offset, uint32_t length, SnesMemoryType memoryType,
...
DllExport void __stdcall GetTilemap(GetTilemapOptions options, PpuState state, uint8_t* vram, uint8_t* cgram,
                                    uint32_t* buffer)
{
	auto dbg = GetDebugger();
...
DllExport void __stdcall GetTileView(GetTileViewOptions options, uint8_t* source, uint32_t srcSize, uint8_t* cgram,
                                     uint32_t* buffer)
{
	auto dbg = GetDebugger();
...
DllExport void __stdcall GetSpritePreview(GetSpritePreviewOptions options, PpuState state, uint8_t* vram,
                                          uint8_t* oamRam, uint8_t* cgram, uint32_t* buffer)
{
	auto dbg = GetDebugger();
...
DllExport void __stdcall GetGameboySpritePreview(GetSpritePreviewOptions options, GbPpuState state, uint8_t* vram,
                                                 uint8_t* oamRam, uint32_t* buffer)
{
	auto dbg = GetDebugger();
...
DllExport void __stdcall GetEventViewerEvent(CpuType cpuType, DebugEventInfo* evtInfo, uint16_t scanline,
                                             uint16_t cycle, EventViewerDisplayOptions options)
{
	auto dbg = GetDebugger();
